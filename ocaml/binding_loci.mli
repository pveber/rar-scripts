...
val make : 
  ...
  (string * int * int * int) array (** chromosome name, center of the region, width of the region, number of peaks involved *)

val of_macs_targets : 
  radius:int ->
  ?pvalue:float ->
  Macs.peak Bed.file list -> Location.t array value
